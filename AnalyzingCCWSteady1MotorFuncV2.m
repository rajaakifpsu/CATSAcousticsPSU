%Version 2: Uses percent error instead of error to determine windows. The
%reason for this is that, since RPM usually has a larger value, its error was
%usually larger and so it was weighted too heavily. Same for Fz, slightly.
%Now, if I use percent error, they should be weighted properly.
