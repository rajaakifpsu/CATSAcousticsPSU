%function [testData,DIVINEwindows]=AnalyzingCCWSteady1MotorFunc(tests, testnums)
function DIVINEwindows=AnalyzingCCWSteady1MotorFunc(testData, tests, testnums)
