...
clc
%THIS CODE IS OUT OF DATE! See Version 1 for the code that works!
%Version 2-in calculating avErrors, use the mean of the entire test (stored
%in FsMsRPMs)
...
sampleRate=20000; %200000 measurements/s
...
%take data from DIVINEwindows and put it into torque profile and thrust
%profile. Have 2 versions of both: corrected for density and uncorrected
%for density 
